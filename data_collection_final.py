...
count = len(oss.listdir("C:\\sign2text_dataset_3.0\\AtoZ_3.0\\A\\"))
c_dir = 'A'
...
cv2.imwrite("C:\\Users\\Raj Aryan\\PycharmProjects\\pythonProject\\white.jpg", white)
    ...
    try:
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            if ord(c_dir) == ord('Z') + 1:
                c_dir = 'A'
            flag = False
            count = len(oss.listdir("C:\\sign2text_dataset_3.0\\AtoZ_3.0\\" + (c_dir) + "\\"))
        ...
        if flag == True:
            ...
            if suv == 180:
                flag = False
            if step % 3 == 0:
                cv2.imwrite("C:\\sign2text_dataset_3.0\\AtoZ_3.1\\" + (c_dir) + "\\" + str(count) + ".jpg", skeleton1)
