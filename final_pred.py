...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model('\\Users\\Raj Aryan\\PycharmProjects\\pythonProject\\cnn8grps_rad1_model.h5')
        ...
        self.root = tk.Tk()
        self.root.title("Sign Language To Text Conversion And Speak", )
        self.root.protocol('WM_DELETE_WINDOW', self.destructor)
        self.root.geometry("1300x700")
        c = tk.Canvas(self.root, bg="skyblue", height="1000", width="1700")
        ...
        self.T.config(text="Sign Language To Text Conversion And Speak", font=("Courier", 30, "bold"))
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread("C:\\Users\\Raj Aryan\\PycharmProjects\\pythonProject\\white.jpg")
